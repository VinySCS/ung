...
<?php
    ...
    <div class="container">
        ...
        <div class="row ">
            ...
            <div class="col-lg-4 text-center " id="divcard7 ">
                <div class="card col-md-12" id="Cards">
                    <div class="card-body" id="Cards">
                        <img src="https://i.pinimg.com/originals/6d/8e/62/6d8e625b79db5010c3da3e6047bf5a2b.jpg" class="ImgCard" style="visibility: hidden;">
                    </div>
                </div>
            </div>
        </div>
